...
//        $name = $email = $gender = $generatedQuery = $website = "";
//        $querystring = "";
...
// 
//SELECT DISTINCT ?events  ?country
//WHERE{
//  ?events seo:field <http://purl.org/seo#WorldWideWeb>;
//         seo:eventWebsite ?webpage;
//     	    seo:heldInCountry ?country.
...
//                $gq .="  ";
        ...
        The aim of developing SPARQL-AG service is to support users who are not familiar, and expert users, in generating SPARQL queries for querying EVENTSKG dataset without going into details how this SPARQL query is written. 
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">  
            ...
            <p> Select column: 
          <p> <input type="checkbox" name="selAll" >all , <input type="checkbox" name="selURI" checked> URI, <input type="checkbox" name="selType" >event type, <input type="checkbox" name="selSeries" > series
			<input type="checkbox" name="selCountry" >country,   <input type="checkbox" name="selCity" >city , <input type="checkbox" name="selField" >field, 
			<input type="checkbox" name="selacc" >acceptance rate ,
                <input type="checkbox" name="selAP">
                accepted papers ,<input name="selSP" type="checkbox" >
                submitted papers ,
                <input name="selStartDate" type="checkbox">
                start date ,
                <input name="selEndDate" type="checkbox"">
                end date,<input type="checkbox" name="selWebsite" >Website 
                 ,<input name="selPublisher" type="checkbox" checked="checked" >
               publisher.          </p>
<p>  Filter:</p>
 <table width="68%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><input label="event type" type="checkbox" name="filType" /> 
      ...
      event type </td>
    <td>&nbsp;</td>
    <td><select name="typeVal" class="form-control" class="form-control">
            <!--selected="selected"-->
...
country </td>
   ...
   <tr>
     <td><input type="checkbox" name="filCity"  >
       city </td>
     <td>&nbsp;</td>
     <td><input name="cityVal" type="text" value="Berlin" size="36" class="form-control" onkeypress="KeyPress(event)/></td>
     <td>&nbsp;</td>
   </tr>
    ...
    <tr>
        ...
        <!--checked="checked"-->
                                                                      ...
                                                                      <tr>
                                                                        ...
                                                                        <td><input name="OptionalAP2" type="checkbox" id="OptionalAP2"/>
OPTIONAL</td>
                                                                      </tr>
                                                                      <tr>
                                                                        ...
                                                                        <td><input name="OptionalSP" type="checkbox" id="OptionalSP"/>
OPTIONAL</td>
                                                                      </tr>
                                                                      <tr>
                                                                        ...
                                                                        <td><input name="OptionalSD" type="checkbox" id="OptionalSD"/>
OPTIONAL&nbsp;-- &nbsp;format&nbsp;<em>YYYY-MM-DD</em> </td>
                                                                      ...
                                                                      <tr>
                                                                        ...
                                                                        <td><input name="OptionalED" type="checkbox" id="OptionalED"/>
OPTIONAL&nbsp;-- &nbsp;format&nbsp;<em>YYYY-MM-DD</em></td>
                                                                      </tr>
                                                                      <tr>
                                                                        ...
                                                                        <td><input name="OptionalAP" type="checkbox" id="OptionalAP"/>
OPTIONAL</td>
                                                                      </tr>
